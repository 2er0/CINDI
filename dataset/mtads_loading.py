...
try:
    from dataset.DatasetUtils.Aneo.extended_loading import create_complete_simple_sequence_iterator_from_grid1
except ImportError:
    print("Real dataset loading not available.")
...
def load_all_stored_datasets(args: dataclass) -> Generator:
    ...
    elif _args.dataset == "aneo_with_noise":
        return create_complete_simple_sequence_iterator_from_grid1()
    else:
